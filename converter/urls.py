...
from .views import ConvertView, history_view, download_fdf, download_pseudos, save_configuration, my_configurations, load_configuration, delete_configuration

urlpatterns = [
    path('convert/', ConvertView.as_view(), name='convert'),
    path('history/', history_view, name='converter_history'),
    path('download/fdf/<int:conv_id>/', download_fdf, name='download_fdf'),
